    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2 text-center">Đăng Ký Tài Khoản</h1>
          <p className="text-gray-600 mb-8 text-center">Đăng ký để nhận ưu đãi và tích điểm thành viên</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-gray-600">
                Đã có tài khoản?{' '}
                <Link href="/login" className="text-[#8B4513] hover:text-[#7a3c12] font-medium">
                  Đăng nhập ngay
                </Link>
              </p>
            </div>
